...
@Component({
  ...
  template: `
    <button class="sb-wrapper sb-expand sb-show-icon sb-button btn btn-icon btn-2 btn-outline-primary btn-sm"
      ...
      <div class="sb-content">
        <div class="sb-icon">
          ...
          <!-- <span class="{{expanded ? lessIcon : moreIcon}}"></span> -->
          <i class="fa fa-ellipsis-v"></i>
        </div>
      </div>
    </button>
  `,
  styleUrls: ['../button/share-button.scss']
})
