...
import { PaginationInstance } from "./pagination-instance.model";
...
export class PaginatePipe {
     ...
     */
    private createInstance(collection: Collection<any>, config: PaginatePipeArgs): PaginationInstance {
     ...
     * last sliced array.
     */
    private saveState(id: string, collection: Collection<any>, slice: Collection<any>, start: number, end: number) {
        this.state[id] = {
            collection,
     ...
     */
    private stateIsIdentical(id: string, collection: Collection<any>, start: number, end: number): boolean {
